                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">
                                    {{ Auth::user()->profil->jam_operasional ?? '-' }}
                                </p>
                                        ...
                                        <div class="active tab-pane" id="settings">
                                            ...
                                            <form method="post" action="{{ route('profile.update') }}"
                                                ...
                                                @if (auth()->user()->role == 'seniman')
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="jam_operasional" class="col-sm-2 col-form-label">Jam
                                                            Operasional</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="jam_operasional"
                                                                class="form-control" id="jam_operasional"
                                                                value="{{ old('jam_operasional', auth()->user()->profil->jam_operasional ?? '') }}">
                                                        </div>
                                                    </div>
                                                @endif
                                                <div class="form-group row">
