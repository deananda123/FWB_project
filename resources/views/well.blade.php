...
<body>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="header-item">
                        <img src="{{asset('konsumen')}}/img/icons/delivery.png" alt="">
                        <p>Free shipping on orders over $30 in USA</p>
                    </div>
                </div>
                <div class="col-md-4 text-left text-lg-center">
                    <div class="header-item">
                        <img src="{{asset('konsumen')}}/img/icons/voucher.png" alt="">
                        <p>20% Student Discount</p>
                    </div>
                </div>
                <div class="col-md-4 text-left text-xl-right">
                    <div class="header-item">
                    <img src="{{asset('konsumen')}}/img/icons/sales.png" alt="">
    ...
    <section class="hero-slider">
        <div class="hero-items owl-carousel">
            <div class="single-slider-item set-bg" data-setbg="{{asset('konsumen')}}/img/slider-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2019</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="lookbok-pic">
                        <img src="{{asset('konsumen')}}/img/lookbok.jpg" alt="">
    ...
    <div class="logo-section spad">
        <div class="logo-items owl-carousel">
            <div class="logo-item">
                <img src="{{asset('konsumen')}}/img/logos/logo-1.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{asset('konsumen')}}/img/logos/logo-2.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{asset('konsumen')}}/img/logos/logo-3.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{asset('konsumen')}}/img/logos/logo-4.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{asset('konsumen')}}/img/logos/logo-5.png" alt="">
            </div>
        </div>
    </div>
    <!-- Logo Section End -->
...
<div class="container text-center pt-5">
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- Js Plugins -->
    <script src="{{asset('konsumen')}}/js/jquery-3.3.1.min.js"></script>
    <script src="{{asset('konsumen')}}/js/bootstrap.min.js"></script>
    <script src="{{asset('konsumen')}}/js/jquery.magnific-popup.min.js"></script>
    <script src="{{asset('konsumen')}}/js/jquery.slicknav.js"></script>
    <script src="{{asset('konsumen')}}/js/owl.carousel.min.js"></script>
    <script src="{{asset('konsumen')}}/js/jquery.nice-select.min.js"></script>
    <script src="{{asset('konsumen')}}/js/mixitup.min.js"></script>
